...
function i(e, t, n) {
let c = "dark" == n ? o : a, i = e.getSVGDocument();
if (!i) return;
let s = [ "fill", "stroke", "stop-color" ];
for (let e of s) for (let t of i.querySelectorAll("[".concat(e, "]"))) {
let n = r(t.getAttribute(e));
if ("none" == n) continue;
let o = c[n];
o && t.setAttribute(e, o);
}
for (let e of i.querySelectorAll("[style]")) for (let t of s) if (e.style[t]) {
let n = r(e.style[t]);
if ("none" == n) continue;
let o = c[n];
o && (e.style[t] = c[o]);
...
//# sourceMappingURL=init.0a89b5228a4598490ad5.js.map